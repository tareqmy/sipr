...
**Current state: v1 shipped, M0–M26 complete** (UDP/TCP/TLS transports, UAC/UAS,
stats + TUI, actions/auth incl. IMS AKA + AUTS resync + `verifyauth`, `-inf` injection, 3PCC, `-users`, IPv6,
